...
- [[docs/guides/AI_KNOWLEDGE_PORTABILITY|AI_KNOWLEDGE_PORTABILITY]] —
  `$harvest-project-lessons`, `$apply-promotion-candidate` и
...
- [[.agents/skills/promote-project-knowledge/SKILL|promote-project-knowledge]] —
  верхнеуровневый orchestration workflow: решает, lesson остаётся локальным,
  идёт в harvesting или уже готов к apply.
- [[.agents/skills/harvest-project-lessons/SKILL|harvest-project-lessons]] —
  просматривает соседние проекты и собирает shortlist кандидатов на promotion
  в общий backlog.
- [[.agents/skills/apply-promotion-candidate/SKILL|apply-promotion-candidate]] —
  берёт один approved-кандидат и превращает его в checked-in изменение набора
  правил.
