...
- **Получение ключа:** Личный кабинет ИТС → «Сервисы» → «1С:Напарник для
  разработки» → активировать тарифный план → раздел «Ключи доступа» → выбрать
  сервис и добавить нужное число ключей. Один ключ = один разработчик, до 100
  ключей на аккаунт ИТС. Страница сервиса:
...
| Что | Ссылка |
|---|---|
| Активация сервиса и получение ключей (ИТС) | <https://portal.1c.ru/applications/1C-Second-Pilot> |
