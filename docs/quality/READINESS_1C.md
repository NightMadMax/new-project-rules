...
Из 31 критерия: `тест` — 17, `частично` — 4, `Windows` — 0, `не выполнено` — 9, `отложено` — 1.
...
- **№173 — у диагностики среды нет машинного исполнителя** (критерии 10, 11,
  12, 13, 14, 15, 17, 19, 20). Гейт живой базы исполнителя получил
  (`scripts/one_c_session.py`), поэтому критерии 8 и 9 закрыты тестом. Правила записаны в skills и в scoped
