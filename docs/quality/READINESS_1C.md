...
Из 31 критерия: `тест` — 11, `частично` — 6, `Windows` — 0, `не выполнено` — 14.
...
- **№172 — upstream импортирован, но не доставлен** (критерии 22, 25). Ledger
  собран и release `0.1.0` выпущен, поэтому критерий 5 закрыт тестом. Осталась
  доставка: 13 ролей и 13 команд в согласованных проекциях и OpenSpec с четырьмя
  workflow — это строки `config/capabilities.tsv`, а не строки ledger.
