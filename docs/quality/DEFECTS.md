...
| 7 | Расширенные профили создают неполный docs index | 2026-06-29 | 2026-06-29 | pending | Bootstrap обновлял только корневой `INDEX.md`, но не профильные разделы `docs/README.md`. |
| 8 | Claude одновременно optional и required | 2026-06-29 | 2026-06-29 | pending | Environment check не различал agent mode и всегда требовал оба CLI. |
| 9 | Scoped setup создаёт внешний каталог до проверки | 2026-06-29 | 2026-06-29 | pending | Scope path окончательно проверялся только после `mkdir` / `New-Item`. |
| 10 | Bootstrap не откатывает частично созданный проект | 2026-06-29 | 2026-06-29 | pending | Генерация выполнялась прямо в destination без failure cleanup. |
