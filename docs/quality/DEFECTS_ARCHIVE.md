...
Записи `Fixed`, перенесённые из [[docs/quality/DEFECTS|DEFECTS]] при
консолидации. Содержимое записей не менялось; нумерация сквозная с основным
журналом и не переиспользуется.

## Fixed (архив: записи, исправленные до релиза v1.10.0)
