...
1. Сначала читать `docs/jira/STATUS_MODEL.md`, `docs/jira/TRACEABILITY_MODEL.md`, `docs/confluence/DOCUMENT_MODEL.md` и `docs/analytics/QUERY_CATALOG.md`. Разделение ролей двух систем и правило связей — в `references/models.md`.
