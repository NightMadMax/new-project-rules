...
Ключевая идея: **одна папка — это одновременно**

- 🗂️ **Obsidian vault** (заметки и граф связей),
- 🌳 **корень Git-репозитория**,
- ☁️ **отдельный GitHub-репозиторий**.
...
- `operated` — + окружения, runbook, внешние действия, инструменты;
...
Дальше — открыть папку как Obsidian vault, создать GitHub-репозиторий и
работать. Codex и Claude Code сразу знают правила проекта.
